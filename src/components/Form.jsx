...
function Form() {
    ...
    const validform = () => {
        ...
        if (firstname === '') {
            ...
            document.getElementById("f-error").textContent = "Enter valid name"
            valid = false;
        }
        else {
        ...
        if (lastname === '') {
            ...
            document.getElementById("l-error").textContent = "Enter valid last name"
            valid = false;
        }
        else {
        ...
        if (email === "") {
            ...
            document.getElementById("email-error").textContent = "Email must contain one @";
            valid = false;
        } else if (email.indexOf("@") < 2) {
            document.getElementById("email-error").textContent = "Atleast two characters before @";
            valid = false;
        } else if (!email.includes(".")) {
            document.getElementById("email-error").textContent = "Enter valid email";
            valid = false;
        }else if(email.endsWith(".")){
            document.getElementById("email-error").textContent = "Email can't end with dot";
            valid = false;
        }
        else {
        ...
        <>
            <div className="container">
                ...
                <div className='d-flex justify-content-center mt-4'>
                    <form id='form' className="form-content p-5 rounded-2" onSubmit={(e) => {
                        e.preventDefault();
                        { handlesubmit() };
                    }} action="">
                        ...
                        <button className='text-white d-block m-auto bg-dark mt-3 p-1 rounded-2 w-100'>Register</button>
                    </form>
                </div>
